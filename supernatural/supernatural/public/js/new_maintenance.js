                                    ...
                                    frappe.after_ajax(() => {
                                        frappe.ui.form.on("Maintenance Schedule", {
                                            onload: function(ms_frm) {
                                                ...
                                                ms_frm.set_value("transaction_date", values.posting_date);
                                                ms_frm.set_value("custom_installment_date", values.installation_date);
                                                ms_frm.set_value("custom_maintenance_type", values.maintenance_type);
                                            }
                                        });
                                    });
                                } else {
